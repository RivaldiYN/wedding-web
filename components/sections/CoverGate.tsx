    ...
    <AnimatePresence>
      {!isOpen && (
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-48 sm:w-64 h-48 sm:h-64 pointer-events-none opacity-25" aria-hidden="true">
          ...
          <div className="absolute bottom-0 right-0 w-56 sm:w-80 h-56 sm:h-80 pointer-events-none opacity-25 rotate-180" aria-hidden="true">
            <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full text-[#7A5E24]">
              <path d="M10 10C50 30 70 80 40 120C20 90 20 40 10 10Z" stroke="currentColor" strokeWidth="1.2" />
              <path d="M40 30C90 40 120 90 90 140C60 110 50 60 40 30Z" stroke="currentColor" strokeWidth="1.2" />
              <path d="M10 60C60 90 80 150 50 180C20 140 30 90 10 60Z" stroke="currentColor" strokeWidth="1" />
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-15 -z-10" aria-hidden="true">
            <svg width="400" height="400" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#7A5E24]">
          ...
          >
            <p className="font-serif text-sm sm:text-base tracking-[0.2em] text-[#594E3F] uppercase font-medium">
              The Wedding of
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="font-sans text-[11px] sm:text-xs text-[#594E3F] tracking-[0.25em] uppercase font-semibold">
                #withCOB &bull; #TheWeddingCelebration
              </p>
            </div>

            {/* Guest Personalization Box */}
            <div className="mt-6 p-5 sm:p-6 rounded-2xl glass-wedding-card max-w-sm mx-auto space-y-1.5 border border-[#7A5E24]/30 shadow-md">
